function IR_plot_spectrum, wavelength, reflectance, title, save_file, smoothing_int
...
;plot data
oplot, wavelength, smooth(reflectance,smoothing_int),color=0, linestyle=0, thick=4
